 ...
 <section class="h-full grid grid-row-10 p-5">
    <div class="row-span-8 grid grid-cols-10">
        <div class="col-span-5 grid grid-row-10">
            <h1 class="row-span-2 text-3xl font-bold text-center flex items-center justify-center">Visualização mensal</h1>
            <div class="flex items-center justify-center gap-3 text-5xl row-span-3">
            ...
            <h1 class="row-span-2 text-3xl font-bold text-center flex items-center justify-center">Visualização Total</h1>
            <div class="flex items-center justify-center gap-3 text-5xl row-span-3">
                <i class="material-icons " style="font-size: 70px">visibility</i> 
                @if ($AllViews == null)
                    <span>0</span>
        ...
        <div class="col-span-5 p-5">
            @if ($DishViews == null)
                <h1 class="text-center text-3xl font-bold">Sem Pratos por enquanto...</h1>
