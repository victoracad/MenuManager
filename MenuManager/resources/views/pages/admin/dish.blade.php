...
<section class="shadow-2xl p-2 flex flex-col">
    ...
    <div class="flex flex-col pl-10 pr-10">
        ...
        <div class="flex justify-center">
            <a class="h-12 bg-blue-300 flex items-center justify-center rounded-2xl w-[50%] text-white font-bold text-2xl hover:bg-blue-500" href="{{ route('editDish.page', ['dish_id'=>$dish->id]) }}">Editar prato</a>
        </div>
